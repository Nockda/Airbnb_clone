    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('english', 'English'), ('kr', 'Korean')], max_length=10)),
                ('currency', models.CharField(choices=[('dollar', 'US Dollar'), ('won', 'Korean Won')], max_length=10)),
